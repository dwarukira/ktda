...
from ktda.students.utils import grades_with_value
...
class StudentTrend(graphene.ObjectType):
    term = graphene.String()
    mark_value = graphene.String()
...
class Query(graphene.ObjectType):
    ...
    student_trends = graphene.List(StudentTrend, id=graphene.String())
    ...
    def resolve_gender_grade_distribution(self, info):
        ...
        for grade in grades_gen():
            ...
            l.append(GenderGradeDist(
                ...
                total_females=gd.filter(
                    gender="F").count() / total_female * 100,
