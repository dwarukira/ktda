            ...
            <Nav>
                <ul>
                    ...
                    <div className="pt">
                        ...
                        }}> <li> <i className="fas fa-chart-line"></i> Insights </li> </NavLink>
                        <NavLink to="/messages"> <li> <i className="far fa-envelope"></i> Messages </li> </NavLink>
                        <NavLink to="/mentorship"> <li> <i className="far fa-lightbulb"></i> Mentorship </li> </NavLink>
                        <NavLink to="/actions"> <li> <i className="fas fa-hammer"></i> Actions </li> </NavLink>
                    ...
                    <div className="pt">  
                        <NavLink to="/settings"> <li> <i className="fas fa-cogs"></i> Settings </li> </NavLink>
                        <NavLink to="/help"> <li> <i className="fas fa-hands-helping"></i> Help </li> </NavLink>
