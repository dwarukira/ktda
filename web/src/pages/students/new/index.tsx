...
import StyledInput, { StyledSelect, DropdownInput } from "../../../components/form/input";
...
const AddStudent = ({ history }: any) => {
    ...
    const onSubmit = (data: any) => {
        ...
        const s = school.schools.find((school: any) => school.name === data.school_name)
        const factoryData = factory.factories.find((f: any) => f.name === data.factory)
    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <StyledFormActions>
                <Button background={colors.primary} color="white"  > { loading ? "Saving ...." : 'Save Student' } </Button>
