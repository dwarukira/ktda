...
const UplaodDocument = ({ student, setIsOpen }: any) => {
    ...
    return (
        <Form onSubmit={handleSubmit(onSubmit)}>
            ...
            <fieldset>
                <Row className="pt">
                    <Col sm={2}> <label> Source </label> </Col>
                ...
                <Row className="pt">
                    <Input 
                        ...
                        options={["Conset form", "Perfomance", "Application Details", "Fee Statement"]}
            ...
            <StyledFormActions>
                <Button background={colors.primary} color="white"  > Save  </Button>
