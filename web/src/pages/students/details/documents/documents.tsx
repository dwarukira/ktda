    ...
    <>
      ...
      <Padding>
        ...
        <p>
          ...
          quasi vel eveniet expedita consectetur quae dignissimos ut culpa dolor
          reprehenderit vitae officiis similique, ducimus eius. Quidem ipsa
      ...
      {data.student && (
        <Row>
          <Col sm={12}>
            <Document documents={data.student.documents} history={history} />
          </Col>
        </Row>
      )}
    </>
